...
Item {
    ...
    ColumnLayout {
        ...
        Kirigami.InlineMessage {
            ...
            text: i18n("Wenn du eine Trigger-Phrase sprichst, führt ATLAS die Aktion aus statt sie an die KI zu senden.<br><br>" +
                       "<b>App</b> — startet ein Programm. Mit <code>||</code> Fallbacks (z. B. <code>konsole||gnome-terminal||xterm</code>).<br>" +
                       "<b>Befehl</b> — führt einen Shell-Befehl aus.")
        }
        ...
        Kirigami.AbstractCard {
            ...
            contentItem: ColumnLayout {
                ...
                RowLayout {
                    spacing: Kirigami.Units.smallSpacing
                    Label {
                        text: i18n("Wenn ich sage:")
                        font.bold: true
                        Layout.preferredWidth: 100
                    }
                    TextField {
                        id: newPhraseField
                        placeholderText: i18n("z. B. Musik starten")
                        Layout.fillWidth: true
                    }
                }
                ...
                RowLayout {
                    spacing: Kirigami.Units.smallSpacing
                    Label {
                        text: i18n("Dann ausführen:")
                        font.bold: true
                        Layout.preferredWidth: 100
                    }
                    TextField {
                        id: newActionField
                        placeholderText: i18n("z. B. audacious||rhythmbox||vlc")
                        Layout.fillWidth: true
                    }
                }
                ...
                RowLayout {
                    ...
                    ComboBox {
                        id: newTypeCombo
                        model: [
                            i18n("app — Programm starten"),
                            i18n("command — Shell-Befehl")
                        ]
                        Layout.fillWidth: true
        ...
        RowLayout {
            ...
            Button {
                text: i18n("Auf Standard zurücksetzen")
                icon.name: "edit-undo"
    ...
    Dialog {
        id: editDialog
        title: i18n("Sprachbefehl bearbeiten")
        modal: true
        ...
        ColumnLayout {
            ...
            TextField {
                id: editPhraseField
                Layout.fillWidth: true
                placeholderText: i18n("Was du sagst …")
            }

            Label { text: i18n("Aktion:"); font.bold: true }
            TextField {
                id: editActionField
                Layout.fillWidth: true
                placeholderText: i18n("Was passiert …")
            }

            Label { text: i18n("Typ:"); font.bold: true }
            ComboBox {
                id: editTypeCombo
                model: ["app", "command"]
                Layout.fillWidth: true
