...
# Cursor/MTHO-Spec: Fraktale Regelverteilung

**Phase 4 Chat Team A · Stand:** 2026-03-03  
**Ziel:** Regeln so verteilen, dass Cursor/MTHO **funktioniert** (Agenten finden Regeln, keine Duplikate, klare Priorität).
...
- **Ebene 2 (agent-spezifisch):** `.cursor/agents/*.md`. Wer bin ich, Budget, **Holschuld**, welche Skills (Referenz), keine MTHO-Architektur-Kopie.
...
| Core DNA, GTAC/MTHO, Gravitational Query | `docs/01_CORE_DNA/...` | Nur Verweis in .cursorrules; keine Kopie. |
