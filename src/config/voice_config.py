...
"""
_FALLBACK_VOICE_ID = "NE7AIW5DoJ7lUosXV2KR"  # core_dialog (Standard ATLAS)

OSMIUM_VOICE_CONFIG = {
    # --- Operative Layer (3 profiles) ---
    "core_high_density": {"voice_id": _FALLBACK_VOICE_ID, "stability": 0.85, "similarity_boost": 0.90, "style": 0.0},
    "core_info":         {"voice_id": _FALLBACK_VOICE_ID, "stability": 0.75, "similarity_boost": 0.85, "style": 0.0},
    ...
    "analyst":            {"voice_id": _FALLBACK_VOICE_ID, "stability": 0.95, "similarity_boost": 0.95, "style": 0.0},
    ...
    "zero_architekt":     {"voice_id": _FALLBACK_VOICE_ID, "stability": 0.60, "similarity_boost": 0.80, "style": 0.1},
    "kurator":            {"voice_id": _FALLBACK_VOICE_ID, "stability": 0.90, "similarity_boost": 0.90, "style": 0.0},
    "bias_damper":        {"voice_id": _FALLBACK_VOICE_ID, "stability": 0.85, "similarity_boost": 0.95, "style": 0.0},
