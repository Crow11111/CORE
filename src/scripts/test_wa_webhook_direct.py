...
"""
Test: POST an ATLAS_CORE /webhook/whatsapp (simuliert HA-Aufruf).
Prüft die API-Route isoliert. ATLAS_CORE API muss laufen (z. B. uvicorn auf API_PORT).
...
def main():
    ...
    try:
        ...
        print("Verbindungsfehler – läuft die ATLAS_CORE API (uvicorn)?")
        return 1
