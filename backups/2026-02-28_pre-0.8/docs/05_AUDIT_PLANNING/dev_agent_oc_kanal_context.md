...
- [KANAL_ATLAS_OC.md](../02_ARCHITECTURE/KANAL_ATLAS_OC.md) – Übersicht Kanal, Gateway-Config, Hinweis 405/Neustart
- [STAMMDOKUMENTE_DEPLOY.md](../04_PROCESSES/STAMMDOKUMENTE_DEPLOY.md) – Ablage Stammdokumente auf VPS, WhatsApp-Info an OC
