...
- **mmWave Sensor** (`_TZE200_bdb16fsr`): User sucht ihn noch (liegt im Schrank, nicht angeschlossen). DDF-Datei liegt bereit: `c:\ATLAS_CORE\tuya_mmwave_sensor.json`. Muss auf Raspi in deCONZ eingespielt werden (Phoscon "Edit DDF" oder Dateisystem).
