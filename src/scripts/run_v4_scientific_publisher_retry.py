...
Das Dokument MUSS SEHR UMFANGREICH sein. Es darf keine Informationen aus V3 oder den Deep Research Dokumenten verlieren. Es muss mindestens 5000-8000 Wörter umfassen.
...
ACHTUNG: Das letzte generierte Dokument war mit 1600 Wörtern viel zu kurz! Du musst ALLE Details, Formeln, Herleitungen, empirischen Knoten und die gesamte kognitive UI/Architektur in voller Tiefe ausarbeiten. Lass nichts weg!
"""
