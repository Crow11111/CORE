...
Usage:
    ...
    python -m src.scripts.seed_mtho_knowledge_base --dry-run
"""
import json
import os
import sys
...
def _load_json():
    path = os.path.join(
        os.path.dirname(__file__), "..", "..", "data", "knowledge_base", "mtho_knowledge_chromadb_import.json"
    )
    if not os.path.exists(path):
        path = r"c:\MTHO_CORE\data\knowledge_base\mtho_knowledge_chromadb_import.json"
