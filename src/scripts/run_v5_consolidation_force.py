...
- ACHTUNG: Das Dokument MUSS extrem lang sein (mindestens 10.000 bis 15.000 Wörter), da es ALLE Inhalte der 24 Quelldokumente unkomprimiert vereinen muss! Wenn du kürzst, versagst du.
"""

prompt_lehrbuch = f"""
ROHDATEN (ALLE 24 DOKUMENTE):
{all_content}

Erstelle jetzt die `FTOE_Theorie_der_latenten_Zeit_V5_Lehrbuch_Consolidated.md`.
Verliere kein einziges Beispiel, keine Formel und keinen Absatz aus den Rohdaten. Füge alles in die Struktur ein.
"""

try:
    print("Starte Lehrbuch Konsolidierung (Force Length)...")
...
- Integriere alle Deep Research Dokumente.
- ACHTUNG: Das Dokument MUSS extrem lang sein (mindestens 10.000 Wörter), da es ALLE Inhalte der 24 Quelldokumente vereinen muss! Wenn du harte Fakten oder Formeln weglässt, versagst du.
"""
...
try:
    print("Starte Scientific Konsolidierung (Force Length)...")
    ...
    print(f"Fehler in Scientific: {e}")
