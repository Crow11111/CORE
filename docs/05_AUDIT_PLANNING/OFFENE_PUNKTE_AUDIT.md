...
| **WhatsApp-Webhook-Routing** | Vollständiger Pfad: Nachricht → HA (Addon) → rest_command → ATLAS FastAPI `/webhook/whatsapp`. Siehe [WHATSAPP_E2E_HA_SETUP.md](../03_INFRASTRUCTURE/WHATSAPP_E2E_HA_SETUP.md). |
