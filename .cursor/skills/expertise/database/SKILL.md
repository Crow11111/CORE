...
description: Fachgebiet Datenbank-Design und -Betrieb für Schicht-3-Produzenten. ChromaDB, PostgreSQL, SQLite. Schema-Design, Indexing, Migration, Embedding-Strategien. ATLAS Collections.
---
...
| SQLite | argos_knowledge_graph (lokal) |
...
## ATLAS Collections (ChromaDB)

| Collection | Zweck |
|------------|-------|
| argos_knowledge_graph | KG-Relationen, ND-Insights, RAG |
| core_brain_registr | Immutable Systemdaten, Confidence ≥ 0.99 |
| session_logs | Gesprächs-Sessions, semantische Suche |
| events | Atlas-Events, Event-Log |
...
- argos_knowledge_graph: component1, component2, relation_type, source_file
