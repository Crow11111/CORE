...
ATLAS ist ein autonomes KI-Agentensystem, das als Smart-Home-Steuerung, Sprachassistent und verteiltes Reasoning-System arbeitet. Es verbindet Home Assistant, Cloud-LLMs und lokale Hardware zu einem selbstverwaltenden System.

**Zum Namen:** ATLAS wurde urspruenglich als mythologische Metapher gewaehlt -- ein Schutzraum, der externe Unlogik (NT-Rauschen) vom ND-Kern fernhaelt. Erst Monate spaeter stellte sich heraus, dass der Name rueckwaerts konstruiert exakt die Architektur beschreibt: **A**utonomous **T**etralogy **L**ogic & **A**gent **S**ystem.
...
ATLAS basiert auf einer **4-Strang-Architektur (Tetralogie):**
...
Volltext: `docs/01_CORE_DNA/ATLAS_4_STRANG_THEORIE.md`
...
|--------|-------|----------|
| **Dreadnought** | Windows-PC, Backend, TTS, Vision | Lokal |
| **Scout** | Raspberry Pi 5, Home Assistant, Sensoren | Lokal |
| **VPS (Hostinger)** | OC Brain, VPS-Slim Failover, ChromaDB | Cloud |
...
|--------|------|--------------|
| ATLAS Backend | 8000 | FastAPI, Webhooks, Voice, HA-Integration |
| VPS-Slim | 8001 | Failover bei HA-Ausfall |
| TTS Stream | 8002 | Audio-Streaming zu Mini-Speaker |
| CRADLE | 8049 | Rule-Injection + Vector-Sync |
| OC Brain | 18789 | OpenClaw Gateway (VPS) |
...
| Architektur-Theorie | `docs/01_CORE_DNA/ATLAS_4_STRANG_THEORIE.md` |
| System-Architektur | `docs/02_ARCHITECTURE/` |
| G-ATLAS Circle (CRADLE) | `docs/02_ARCHITECTURE/G_ATLAS_CIRCLE.md` |
| Event-Bus | `docs/02_ARCHITECTURE/ATLAS_EVENT_BUS.md` |
| Voice Pipeline | `docs/02_ARCHITECTURE/ATLAS_VOICE_ASSISTANT_ARCHITECTURE.md` |
...
| State Vector | `src/config/atlas_state_vector.py` |
| Visueller Masterplan | `ATLAS_WUJI_MASTER_PLAN.png` |
...
`AGENTS.md` (Projekt-Root) – Bootloader mit State Vector, LPIS-Codierung und Quick Links.
