...
* **Microsoft-Telemetrie auf Level 0 zwingen:**
  + *Hinweis (Universal Board):* Windows 11 Enterprise IoT 25H2 ist die einzige Edition, die Telemetrie "Level 0" (Aus) nativ respektiert, was essenziell ist, um externe Störfaktoren für das CORE LLM auszuschließen.
