...
| fetch_oc_submissions Roundtrip | LÄUFT | Z15: OC schreibt, 4D_RESONATOR (MTHO_CORE) holt |
...
- Hören: Pipeline Scout-Mikro/Assist → MTHO.
...
- **MTHO Sprechen:** `python -m src.scripts.test_atlas_speak` – TTS (ElevenLabs) und/oder WhatsApp via HA. TTS getestet (OK); WhatsApp sobald Scout/HA wieder erreichbar.
