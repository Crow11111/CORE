...
| **Hören** | 4D_RESONATOR (MTHO_CORE) Recording Pipeline | **OK** | `dreadnought_listen.py` sendet Audio-Event an OMEGA_ATTRACTOR |
...
2. **Computer Vision:** MTHO soll die gesehenen Bilder analysieren (Vision-Modell im OMEGA_ATTRACTOR Task-Loop).
