...
- **2026-04-08 (MCP query_canon_x007):** `mcp_omega_state.py` Tool auf `core_canon`; Tests `test_mcp_omega_state.py`; CANON_REGISTRY, AGENTS, Skill Bootstrap.
...
- **2026-04-08 (Soll/Ist: core_operational + Kernarbeiter):** `KERNARBEITER_ORIENTIERUNG.md`, `KERNARBEITER_SURFACE_PATHS.yaml`, `ingest_omega_operational_chroma.py`, `COLLECTION_CORE_OPERATIONAL`, MCP **`query_operational_x007`**, Refactor `_chroma_semantic_query`; Tests `test_ingest_omega_operational_chroma.py`; MIGRATIONPLAN 2b, Schemas, KANON, Inventar, CLAUDE, AGENTS.
