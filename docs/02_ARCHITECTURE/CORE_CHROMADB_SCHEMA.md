...
| **core_canon** | Default (384) | Soll-Kanon aus `omega_canon_documents` (Chunk-Ingest) |
| **core_operational** | Default (384) | Ist-/Lauffläche (`KERNARBEITER_SURFACE_PATHS.yaml`), getrennt von `core_canon` |
