...
"""
ATLAS Vision Daemon (The All-Seeing Eye)
----------------------------------------
...
# Konfiguration
RTSP_URL = os.getenv("ATLAS_RTSP_URL", "rtsp://192.168.178.54:8554/mx_brio")
...
class AtlasVisionDaemon:
    ...
    def analyze_frame(self, frame):
        ...
        try:
            ...
            prompt = (
                "ATLAS SYSTEM MESSAGE: Describe what you see in this security feed. "
