...
<head>
<meta charset="UTF-8">
<title>ATLAS Fibonacci-Spirale — 55 Indizien, 11 Vektoren</title>
<style>
...
out_path = os.path.join(os.path.dirname(__file__), "..", "..", "media", "atlas_spiral_3d.html")
