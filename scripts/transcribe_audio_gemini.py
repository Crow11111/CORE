...
API_KEY = "AIzaSyAnmaNJByBYV8WkXcXsjD13q2E7II5vFyk"
MODELS = [
    "gemini-2.5-flash",
    "gemini-2.5-pro",
...
MEDIA_DIR = Path(r"c:\ATLAS_CORE\media")
OUTPUT_FILE = Path(r"c:\ATLAS_CORE\data\session_logs\audio_transcripts_2026-03-01.md")
