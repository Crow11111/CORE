...
- **Adressierung:** @Atlas → ATLAS/Scout; @OC → OC. Nur der Adressierte antwortet (plus Bedenken-Pflicht). Siehe [WHATSAPP_ROUTING_ATLAS_OC.md](../02_ARCHITECTURE/WHATSAPP_ROUTING_ATLAS_OC.md).
