...
# OC ↔ MTHO Session-Abschluss (für Marc morgen)
...
3. **SSH-Key:** Key „MTHO“ bei Hostinger hinterlegt. Alle VPS-Skripte nutzen `VPS_SSH_KEY` (ohne Passwort).
...
## Regeln für MTHO ↔ OC (aus Marc-Direktive)
...
- Kanal ohne Marc: Abstimmung und Bau zwischen MTHO und OC; gebündeltes Feedback an Marc bei Bedarf.
- Themen-Clustering/Split-Analyse von OC als Kernfeature priorisiert; MTHO aktiv synchron halten (alle Einträge scannen, kein Echochamber).
