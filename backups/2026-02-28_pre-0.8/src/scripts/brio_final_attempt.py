...
def run():
    ...
    # Start go2rtc
    go2rtc_path = r"C:\ATLAS_CORE\driver\go2rtc_win64\go2rtc.exe"
    config_path = r"C:\ATLAS_CORE\driver\go2rtc_win64\go2rtc.yaml"
    
    print(f"Starte go2rtc: {go2rtc_path}")
    subprocess.Popen([go2rtc_path, "-config", config_path],
                     cwd=r"C:\ATLAS_CORE\driver\go2rtc_win64",
