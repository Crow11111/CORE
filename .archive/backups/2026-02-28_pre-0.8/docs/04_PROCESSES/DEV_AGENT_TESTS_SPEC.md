...
**Ergänzung (OC-Kanal + Frontend-Backend):** [TEST_SZENARIEN_OC_UND_FRONTEND.md](../05_AUDIT_PLANNING/TEST_SZENARIEN_OC_UND_FRONTEND.md) – Szenarien für ATLAS↔OC (Daten bei OC, Abstimmen) und Dev-Agent-Frontend↔Backend (Verbindung, kein "Nicht verbunden"). Skripte: `test_atlas_oc_channel.py`, `fetch_oc_submissions.py`, `test_frontend_backend.py`. Dev-Agent-Kontext für OC-Kanal-Review: [dev_agent_oc_kanal_context.md](../05_AUDIT_PLANNING/dev_agent_oc_kanal_context.md).
