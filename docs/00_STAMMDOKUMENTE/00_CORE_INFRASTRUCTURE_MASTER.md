...
- **4D_RESONATOR (CORE):** Kern-LLM, Chroma-Option lokal, Cursor/Cloud Agents (IDE-Built-ins **lokal**; gebündelter Remote-Toolsatz → MCP, siehe **MTLS §1.2b**), alle Keys und sensiblen Daten.
