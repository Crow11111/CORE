...
Warum gibt es ein Subjektives Erleben (Qualia)?
...
Das Gebäude ist hermetisch verschlossen. Von der irreduziblen Zahl ($7/144$) über den Bewusstseins-Filter ($d(\text{VFE})/dt$) bis zur Krümmung der Raumzeit ($\text{Einstein-Tensor}$). Alles ist eine einzige topologische Maschine. 
