# MTHO COCKPIT DESIGN (Human-Centric Interface)
...
*   **Kontext-Wechsel (Context Switching):** Der Operator muss zwischen 3-4 Fenstern (API, Watchdog, Forge, Dashboard) wechseln, um den Gesamtzustand zu erfassen.
...
```
+---------------------------------------------------------------+
|  HEADER: MTHO CORE | STATUS: ONLINE | PULS: [~~~~~]           |
+---------------------+-------------------+---------------------+
|                     |                   |                     |
|  1. AGENCY (Feuer)  |  2. FORGE (Fluss) |  3. ARCHIVE (H)   |
...
**Entscheidung:** Wir bauen das existierende React-Frontend (`frontend/`) zum **MTHO Cockpit** aus. Streamlit bleibt als "Legacy Admin Tool" erhalten, bis alles portiert ist.
