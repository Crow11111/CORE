...
Aktuell ist die ATLAS Voice-Pipeline in Home Assistant (`ha_integrations/atlas_conversation`) hart an die IP von Dreadnought (`192.168.178.110:8088`) gebunden. 
